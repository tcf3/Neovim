...
vim.opt.inccommand = "split" -- Opens a split tab when search text (substitute, etc...)
...
vim.opt.showtabline = 2                                 -- Always show nvim tabs
...
-- Make nvim share tmux clipboard
-- Remove if not using or causing deplay on copy - paste inside neovim
vim.g.clipboard = {
  name = "osc52",
  copy = {
